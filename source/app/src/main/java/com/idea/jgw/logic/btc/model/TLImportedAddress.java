...
public class TLImportedAddress {
    ...
    private Map<String, TLWalletUtils.TLAccountTxType> txidToAccountAmountTypeDict;
    ...
    public TLImportedAddress(TLAppDelegate appDelegate, TLWallet appWallet, JSONObject dict) {
        ...
        try {
            ...
            this.archived = addressDict.getInt(TLWalletJSONKeys.WALLET_PAYLOAD_KEY_STATUS) == TLWalletJSONKeys.TLAddressStatus.Archived.getValue();
    ...
    public void getSingleAddressDataO(boolean fetchDataAgain,final TLCallback callback) {
            ...
            public void handleMessage(Message msg) {
                ...
                try {
                    if (jsonData == null || jsonData.has(TLNetworking.HTTP_ERROR_CODE)) {
                        downloadState = TLOperationsManager.TLDownloadState.Failed;
                        if (callback != null) {
