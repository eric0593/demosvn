...
public class TLAccounts {
    ...
    public TLAccounts(TLAppDelegate appDelegate, TLWallet appWallet, List<TLAccountObject> accountsArray, TLWalletUtils.TLAccountType accountType) {
    ...
    public TLAccountObject addAccountWithExtendedKey(String extendedKey, String accountName) {
        assert(accountType != TLWalletUtils.TLAccountType.HDWallet); // "accountType == TLAccountTypeHDWallet"
    ...
    public TLAccountObject createNewAccount(String accountName, TLWalletJSONKeys.TLAccount accountType) {
        TLAccountObject accountObject = this.appWallet.createNewAccount(accountName, TLWalletJSONKeys.TLAccount.Normal, true);
        accountObject.updateAccountNeedsRecovering(false);
        addAccount(accountObject);
        return accountObject;
    }

    public TLAccountObject createNewAccount(String accountName, TLWalletJSONKeys.TLAccount accountType, boolean preloadStartingAddresses) {
        TLAccountObject accountObject = this.appWallet.createNewAccount(accountName, TLWalletJSONKeys.TLAccount.Normal, preloadStartingAddresses);
        addAccount(accountObject);
        return accountObject;
    }
