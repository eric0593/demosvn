...
public class TLCurrencyFormat {
    ...
    public String bigIntegerToBitcoinAmountString(TLCoin coin, TLCoin.TLBitcoinDenomination bitcoinDenomination) {
    ...
    public TLCoin coinFromString(String bitcoinAmount, TLCoin.TLBitcoinDenomination bitcoinDenomination) {
        if (bitcoinDenomination == TLCoin.TLBitcoinDenomination.BTC) {
    ...
    public TLCoin bitcoinAmountStringToCoin(String amount) {
        return amountStringToCoin(amount, TLCoin.TLBitcoinDenomination.BTC);
    }
    ...
    private TLCoin amountStringToCoin(String amount, TLCoin.TLBitcoinDenomination bitcoinDenomination) {
        if (amount.length() != 0) {
    ...
    public String getBitcoinDisplay() {
        TLCoin.TLBitcoinDenomination bitcoinDenomination = this.appDelegate.preferences.getBitcoinDenomination();
        if (bitcoinDenomination == TLCoin.TLBitcoinDenomination.BTC) {
