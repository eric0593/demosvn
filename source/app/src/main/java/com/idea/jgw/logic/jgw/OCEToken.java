 ...
 */
public class OCEToken extends Contract {
    ...
    protected OCEToken(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected OCEToken(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public RemoteCall<TransactionReceipt> setPrice(BigInteger value) {
        final Function function = new Function(
                FUNC_SETPRICE, 
    ...
    public RemoteCall<TransactionReceipt> sendEther(String addr, BigInteger value) {
        final Function function = new Function(
                FUNC_SENDETHER, 
    ...
    public static RemoteCall<OCEToken> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(OCEToken.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }

    public static RemoteCall<OCEToken> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(OCEToken.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }

    public static OCEToken load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new OCEToken(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    public static OCEToken load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new OCEToken(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }
