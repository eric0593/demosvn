...
public class TLImportedAddresses {
    ...
    private TLWalletUtils.TLAccountAddressType accountAddressType;
    TLOperationsManager.TLDownloadState downloadState = TLOperationsManager.TLDownloadState.NotDownloading;

    public TLImportedAddresses(TLAppDelegate appDelegate, TLWallet appWallet, List<TLImportedAddress> importedAddresses, TLWalletUtils.TLAccountAddressType accountAddressType) {
       ...
       final  Handler handler = new Handler(Looper.getMainLooper()) {
            ...
            public void handleMessage(Message msg) {
                ...
                try {
                    ...
                    downloadState = TLOperationsManager.TLDownloadState.Downloaded;
    ...
    public boolean setLabel(String label, int positionInWalletArray) {
        ...
        if (this.accountAddressType == TLWalletUtils.TLAccountAddressType.Imported) {

            this.appWallet.setImportedPrivateKeyLabel(label, positionInWalletArray);
        } else if (this.accountAddressType == TLWalletUtils.TLAccountAddressType.ImportedWatch) {
