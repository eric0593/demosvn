...
public class TransactionDisplay implements Comparable ,Serializable{
    ...
    public TransactionDisplay(String fromAddress, String toAddress, BigInteger amount) {
        this.fromAddress = fromAddress;
        this.toAddress = toAddress;
        this.amount = amount;
    }
